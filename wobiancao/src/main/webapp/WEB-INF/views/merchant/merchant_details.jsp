												...
												<div class="coupon-main">
													...
													<div class="col-xs-2 coupon-shop-logo">
														...
														<div class="coupon-geted-heart text-center">
															<i class="fa fa-heart" style="font-size: 14px; width: 100%; color: #e84b3c">${coupon.likeCount}</i>
														</div>
													</div>
													...
													<div id="coupon_id_${coupon.id}" class="coupon-heart ${couponsLikedMap[coupon.id] != null ? 'coupon-liked' : 'coupon-unliked'}" onclick="pressLikeInViewShop(${coupon.id})">
														<a>
